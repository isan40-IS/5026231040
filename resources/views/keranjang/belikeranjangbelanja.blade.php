...
@section('content')
    ...
    <form action="/keranjangbelanja/storekeranjangbelanja" method="post" class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-6">
                <input class="form-control" type="text" id="KodeBarang" placeholder="Masukkan Kode Barang"
        ...
        <div class="form-group">
            ...
            <div class="col-6">
                <input class="form-control" type="text" id="Jumlah" placeholder="Masukkan Jumlah Barang"
